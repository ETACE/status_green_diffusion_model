...
@add_arg_table s begin
    "--chunk"
        help = "Which chunk of the simulations to run (1-based index)"
		arg_type = Int
		default = 1
	"--no_chunks"
		help = "Total number of chunks to divide the simulations into"
		arg_type = Int
		default = 1
    "config"
...
@everywhere function execute_task(task)
	...
	model = initialize_model(task[:properties])
