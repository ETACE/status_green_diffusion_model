...
function plot_comparison(data, exp1, key1, exp2, key2, title, color1, color2, label1, label2, ribbon, yearly, stages)
	...
	if stages && !yearly
		...
		vline!(pl, [24, 40, 52, 56], linestyle=:dash, color="mediumseagreen", label = "Environmental subsidy")
...
results_policy = load_dataset("policy")

experiments_base = Dict("baseline" => Dict())
experiments_policy = Dict("no_policy" => Dict(:enable_green_subsidy => false, :enable_tax_exemption => false))

data_base = merge_data(results_base, experiments_base)
data_policy = merge_data(results_policy, experiments_policy)

data = mergewith(vcat, data_base, data_policy)
...
### Macro Plots ###
pl = plot_comparison(data, "baseline", "market_penetration", "no_policy", "market_penetration", "Market Penetration","royalblue", "darkorange", "Baseline","No Policy", true, false, true)
savefig(pl,"plots/$name/market_penetration.pdf")

pl = plot_comparison(data, "baseline", "hh_index", "no_policy", "hh_index", "Herfindahl-Hirschman-Index","royalblue", "darkorange", "Baseline","No Policy", true, true, true)
savefig(pl,"plots/$name/hh_index.pdf")

pl = plot_comparison(data, "baseline", "average_weighted_price", "no_policy", "average_weighted_price", "Average weighted price","royalblue", "darkorange", "Baseline","No Policy", true, true, true)
savefig(pl,"plots/$name/average_weighted_price.pdf")

pl = plot_comparison(data, "baseline", "concentration_rate_three", "no_policy", "concentration_rate_three", "Concentration Rate (Top 3 Firms)","royalblue", "darkorange", "Baseline","No Policy", true, false, true)
savefig(pl,"plots/$name/concentration_rate_three.pdf")

pl = plot_comparison(data, "baseline", "ev_share_sales", "no_policy", "ev_share_sales", "EV share","royalblue", "darkorange", "Baseline","No Policy", true, false, true)
...
pl = plot_by_firm(data, "no_policy", keyset, "First Registration Share by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Brown Capital by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Green Capital by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Total Capital by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, " Yearly Production by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Price by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Demand Price by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Money by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Inventory by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Market Share Electric by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Profit by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "revenue by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Sales by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Demand by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
plot!(pl, legend=:outertopright)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Market Share by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Top Consumer Group by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
savefig(pl,"plots/$name/top_consumer_group_by_firm.pdf")

for i in 1:no_firms
	keyy = Symbol("firm_$(i)_consumer_group_dist")
	seriess = deepcopy(get_data_exp_key(data, "no_policy", keyy))
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Capital Cost Share by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Production Cost Share by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, true, true)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Customer Base by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
plot!(pl, legend=:outertopright)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Cumulative Registrations by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
plot!(pl, legend=:outertopright)
...
keyset = keyset_raw[1:no_firms]
pl = plot_by_firm(data, "no_policy", keyset, "Status Utility by Firms", labelset_firms_class, colorpalette_firms, linestyle_firms, false, false, true)
plot!(pl, legend=:outertopright)
...
pl = plot_comparison(data, "baseline", key11, "no_policy", key11, "Customer Base Eco Base", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/customer_base_eco_base.pdf")

key12 = Symbol("firm_$(number_eco_base)_first_registration_share")
pl = plot_comparison(data, "baseline", key12, "no_policy", key12, "First Registration Share Eco Base", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/first_reg_share_eco_base.pdf")

key13 = Symbol("firm_$(number_eco_base)_demand_price")
pl = plot_comparison(data, "baseline", key13, "no_policy", key13, "Demand price Eco Base", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
...
mean_base, _, _ = get_mean_upper_lower(series_base)
plot!(pl, x_quarterly, mean_base, color="royalblue", label="Baseline")
series_pol = deepcopy(get_data_exp_key(data, "no_policy", Symbol("firm_$(number_eco_base)_cum_registrations")))
mean_pol, _, _ = get_mean_upper_lower(series_pol)
plot!(pl, x_quarterly, mean_pol, color="darkorange", label="No Policy")
vline!(pl, [0, 4, 8, 28], linestyle=:dash, color=STAGES_COLOR, label="")
...
pl = plot_comparison(data, "baseline", key21, "no_policy", key21, "Customer Base Eco Lux", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/customer_base_eco_lux.pdf")

key22 = Symbol("firm_$(number_eco_lux)_first_registration_share")
pl = plot_comparison(data, "baseline", key22, "no_policy", key22, "First Registration Share Eco Lux", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/first_reg_share_eco_lux.pdf")

key23 = Symbol("firm_$(number_eco_lux)_demand_price")
pl = plot_comparison(data, "baseline", key23, "no_policy", key23, "Demand price Eco Lux", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/demand_price_eco_lux.pdf")

pl = plot(title="", fontfamily="Computer Modern", size=(700, 450))
series_base = deepcopy(get_data_exp_key(data, "baseline", Symbol("firm_$(number_eco_lux)_cum_registrations")))
mean_base, _, _ = get_mean_upper_lower(series_base)
plot!(pl, x_quarterly, mean_base, color="royalblue", label="Baseline")
series_pol = deepcopy(get_data_exp_key(data, "no_policy", Symbol("firm_$(number_eco_lux)_cum_registrations")))
mean_pol, _, _ = get_mean_upper_lower(series_pol)
plot!(pl, x_quarterly, mean_pol, color="darkorange", label="No Policy")
vline!(pl, [0, 4, 8, 28], linestyle=:dash, color=STAGES_COLOR, label="")
...
pl = plot_comparison(data, "baseline", key31, "no_policy", key31, "Customer Base Eco Mid", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/customer_base_eco_mid.pdf")

key32 = Symbol("firm_$(number_eco_mid)_first_registration_share")
pl = plot_comparison(data, "baseline", key32, "no_policy", key32, "First Registration Share Eco Mid", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/first_reg_share_eco_mid.pdf")

key33 = Symbol("firm_$(number_eco_mid)_demand_price")
pl = plot_comparison(data, "baseline", key33, "no_policy", key33, "Demand price Eco Mid", "royalblue", "darkorange", "Baseline", "No Policy", true, false, true)
savefig(pl, "plots/$name/demand_price_eco_mid.pdf")

pl = plot(title="", fontfamily="Computer Modern", size=(700, 450))
series_base = deepcopy(get_data_exp_key(data, "baseline", Symbol("firm_$(number_eco_mid)_cum_registrations")))
mean_base, _, _ = get_mean_upper_lower(series_base)
plot!(pl, x_quarterly, mean_base, color="royalblue", label="Baseline")
series_pol = deepcopy(get_data_exp_key(data, "no_policy", Symbol("firm_$(number_eco_mid)_cum_registrations")))
mean_pol, _, _ = get_mean_upper_lower(series_pol)
plot!(pl, x_quarterly, mean_pol, color="darkorange", label="No Policy")
vline!(pl, [0, 4, 8, 28], linestyle=:dash, color=STAGES_COLOR, label="")
...
series_compact = deepcopy(get_data_exp_key(data, "no_policy", Symbol("firm_$(number_eco_base)_cum_registrations")))
...
series_executive = deepcopy(get_data_exp_key(data, "no_policy", Symbol("firm_$(number_eco_lux)_cum_registrations")))
...
series_large = deepcopy(get_data_exp_key(data, "no_policy", Symbol("firm_$(number_eco_mid)_cum_registrations")))
...
savefig(pl, "plots/$name/cum_registrations_evs.pdf")
...
attribute_list_greenness = extract_attributes(data,"no_policy",keyset1)
attribute_list_prestige = extract_attributes(data,"no_policy",keyset3)
...
pl = plot_comparison(data,"baseline","green_prestige_ratio","no_policy", "green_prestige_ratio", "Average Green/Prestige Consumption","royalblue","darkorange", "Baseline","No Policy", true,false,true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Car owner share by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Owned Product Greenness by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Owned Product prestige by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Total Utility by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average Green Status by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average Green Distinction Utility by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average Green Imitation Utility by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average prestige Status by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average prestige Distinction Utility by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average prestige Imitation Utility by Groups", labelset_cons, colorpalette_cons, true)
savefig(pl,"plots/$name/prestige_imitation_group.pdf")

keyset = ["status_group1", "status_group2", "status_group3", "status_group4"]
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average Status by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average Identity Utility by Groups", labelset_cons, colorpalette_cons, true)
...
pl = plot_by_consumption_group(data, "no_policy", keyset, "Average Utility of Remaining Budget by Groups", labelset_cons, colorpalette_cons, true)
